...
abstract class $TodoCopyWith<$Res> {
  ...
  $Res call({String id, String title, String note, bool isComplete});
}
...
class _$_Todo implements _Todo {
  ...
  @override
  String toString() {
    return 'Todo(id: $id, title: $title, note: $note, isComplete: $isComplete)';
  }
...
abstract class _Todo implements Todo {
  const factory _Todo(
      ...
      required String title,
      required String note,
      required bool isComplete}) = _$_Todo;
